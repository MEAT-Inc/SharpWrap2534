...
namespace SharpExpressions
{
    ...
    public class PassThruExpressionRegex
    {
        ...
        private static Dictionary<PassThruExpressionTypes, PassThruExpressionRegex> _loadedExpressions;
        ...
        public static Dictionary<PassThruExpressionTypes, PassThruExpressionRegex> LoadedExpressions => _loadedExpressions ??= _generateRegexModels();
        ...
        public PassThruExpressionTypes ExpressionTypes { get; set; }
        ...
        internal PassThruExpressionRegex(string ExpressionName, string ExpressionPattern, PassThruExpressionTypes ExpressionTypes = PassThruExpressionTypes.NONE, params int[] ExpressionGroups)
        {
            ...
            _loadedExpressions ??= new Dictionary<PassThruExpressionTypes, PassThruExpressionRegex>();
            if (_loadedExpressions.ContainsKey(ExpressionTypes)) _loadedExpressions[ExpressionTypes] = this;
            else _loadedExpressions.Add(ExpressionTypes, this);
        }
        ...
        private static Dictionary<PassThruExpressionTypes, PassThruExpressionRegex> _generateRegexModels()
        {
            ...
            foreach (var RegexJToken in LoadedRegexArray)
            {
                ...
                Enum.TryParse(ExpressionTypeString, out PassThruExpressionTypes ExpressionType);
