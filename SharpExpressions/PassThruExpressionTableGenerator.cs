...
{
    /// <summary>
    /// Static helper class used to build formatted table output
    /// </summary>
    internal static class PassThruExpressionTableGenerator
    {
        /// <summary>
        ...
        /// <returns></returns>
        public static string ToStringTable<T>(this IEnumerable<T> TableValues, string[] ColumnHeaders,
        ...
        /// <param name="ValueSelectors"></param>
        /// <returns></returns>
        public static string ToStringTable<T>(this T[] TableValues, string[] ColumnHeaders,
            params Func<T, object>[] ValueSelectors)
        {
